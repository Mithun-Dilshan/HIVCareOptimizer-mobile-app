    ...
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView style={styles.formContainer}>
        <View style={styles.titleRow}>
          <Icon name="dna" size={24} color={COLORS.primary} />
          <Text style={styles.formTitle}>DRUG RESISTANCE DATA</Text>
        </View>
        ...
        <View style={styles.buttonRow}>
          <TouchableOpacity
            ...
            disabled={loading}
          >
            <Icon name="arrow-left" size={20} color={COLORS.text} style={styles.buttonIcon} />
            <Text style={styles.secondaryButtonText}>Previous</Text>
          </TouchableOpacity>
          <TouchableOpacity 
            style={[styles.analyzeButton, loading && styles.buttonDisabled]} 
          ...
          >
            {loading ? (
              ...
              <View style={styles.buttonContent}>
                <Icon name="magnify" size={20} color={COLORS.white} style={styles.buttonIcon} />
                <Text style={styles.buttonText}>Analyze Now</Text>
              </View>
            )}
          </TouchableOpacity>
